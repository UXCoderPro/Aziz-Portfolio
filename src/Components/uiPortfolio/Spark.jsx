...
import { SparklesCore } from "../uiPortfolio/Sparkles";

const Spark = ({ name, title }) => {
  return (
    <div className="relative h-[40rem] w-full bgg-blue-100 flex flex-col items-center justify-center overflow-hidden rounded-md">
      ...
      <div className="w-[40rem] h-40 relative">
        ...
        <div className="absolute inset-0 w-full h-full bg-blue [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      </div>
    </div>
  );
};
